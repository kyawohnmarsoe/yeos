...
const Submit = () => {
    return (
        ...
        <section className="body-wapper pb-5">
            <div className="container">
                <div className=" yeo-signup font-weight-bold text-center text-sm-left px-5">
                    ...
                    <div className="text-center mb-5">
                        <button type="submit" className="btn btn-brown  signup-btn py-1 mx-2 my-2"> Next</button>
                        </div>
                </div>
            </div>
            </section>
            ...
            <section className="body-wapper pb-5">
                <div className="container">
                <form className=" yeo-signup font-weight-bold text-center text-sm-left px-5">
                    <h2 className="text-center mb-5">Submit</h2>
                    <img src="assets/img/win.png" alt="Prize" className="img-fluid mb-5"/>
                    ...
                    <div className="text-center my-5">
                        <button type="submit" className="btn btn-brown  signup-btn py-1 mx-2 my-2"> Submit</button>
                        </div>
                </form>
                </div>
            </section>
